...
namespace PadlockSystem
{
    public class PadlockController : MonoBehaviour
    {
        ...
        IEnumerator CorrectCombination()
        {
            ...
            Debug.Log($"### This Padlock is {gameObject}");
            ...
            Debug.Log("### After Unlock Padlock Function");
            ...
            Debug.Log("### Finished Correct Combination");
        }
        ...
        public void CheckCombination()
        {
            ...
            Debug.Log($"### Current PadlockController is {gameObject}");
            Debug.Log($"### combinationRow1: {combinationRow1}, combinationRow2: {combinationRow2}, combinationRow3: {combinationRow3}, combinationRow4: {combinationRow4}");
            Debug.Log($"### hasUnlocked status is {hasUnlocked}");
            ...
            if (playerCombi == yourCombination)
            {
                if (!hasUnlocked)
                {
                    ...
                    Debug.Log($"### Unlocked {gameObject}, Next Run");
                    hasUnlocked = true;
                    Debug.Log($"### hasUnloced is {hasUnlocked}");
                }
            }
        }
